...
<form class="Reg" action="Farmerregister.do"  modelAttribute="farmer" method="post" enctype="multipart/form-data" onsubmit="return valid()">
  <!-- <div class="tab">-->Personal Details  
    <p><input type="text" placeholder="Full Name" name='full_name' id='fname' requiredss/><div id='id1' class='error'></div></p>
    <p><input type="text" placeholder="Contact No"  name='contact_no' id='contact' requiredss/><div id='id2' class='error'></div></p>
    <p><input type="email" placeholder="E-mail..."  name='f_email' id='f_email' requiredss /><div id='id3' class='error'></div></p>
  <!-- </div>

  <div class="tab">Address Details  -->
    <p><input type="text" placeholder="Address line 1" name="address" id='addr1' requiredss/><div id='id4' class='error'></div></p>
    <p><input type="text" placeholder="Address line 2" name="address" id="addr2" requiredss/></p>
    <p><input type="text" placeholder="City"   name="city" id="city" requiredss/></p>
    <p><input type="text" placeholder="State"  name="state" id="state" requiredss/></p>
    <p><input type="text" placeholder="Pin Code"  name="pincode" id="pincode" /></p>
    LAND Details
    <p><input type="text" placeholder="Address" name="land_address"  id="addr" requiredss/></p>
    <p><input type="number" placeholder="Area" name="land_area" inputmode="area" requiredss/></p>
    <p><input type="text" placeholder="Pin Code" name="land_pincode" id="pincode1" /></p>
    <!-- </div>
  ...
  <!-- </div>
   ...
   <div class="tab"> -->Document Upload
    ...
    <p><input type="file" placeholder="certificate" name="file" id="certificate"></p>
  <!-- </div>
